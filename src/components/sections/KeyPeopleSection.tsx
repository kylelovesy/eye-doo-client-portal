  ...
  return (
    <div className="max-w-6xl mx-auto px-2">
      <div className="text-center mb-4">
        <h1 className="text-3xl md:text-4xl font-serif mb-4">Key People</h1>
        ...
        {isLocked && !isFinalized && actionOn === ActionOn.PHOTOGRAPHER && (
          <Alert variant="warning" className="max-w-3xl mx-auto mb-4">
            ...
            <AlertDescription>
              Your photographer is reviewing the details. Please contact them if
              changes are needed.
            </AlertDescription>
          </Alert>
        )}
        {actionOn === ActionOn.CLIENT &&
          !isLocked &&
          !isFinalized &&
          currentStepData?.requiredStep !== false &&
          showActionRequired && (
            <Alert
              variant="default"
              className="max-w-3xl mx-auto mb-4 relative text-left py-2"
            >
      ...
      {(keyPeople.items ?? []).length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {(keyPeople.items ?? []).map((person) => (
            <Card
              key={person.id}
              className="relative px-4 py-2 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            >
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-0.5">
            ...
            <Select
              ...
              onValueChange={(value) =>
                setFormState({ ...formState, role: value as KeyPersonRole })
              }
            >
              ...
              <SelectContent>
                {Object.values(KeyPersonRole).map((r) => (
          ...
          <div className="space-y-0.5">
            ...
            <Select
              value={formState.involvement}
              onValueChange={(value) =>
                setFormState({
                  ...formState,
                  involvement: value as KeyPersonInvolvement,
                })
              }
            >
              <SelectTrigger className="w-full">
              ...
              <SelectContent>
                {Object.values(KeyPersonInvolvement).map((a) => (
          ...
          <div className="grid grid-cols-2 gap-1">
            <div className="flex items-center text-left space-x-1">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setFormState({ ...formState, isVIP: !!checked })
                }
              />
              <Label
                htmlFor="isVIP"
            ...
            <div className="flex items-center text-left space-x-1">
              <Checkbox
                id="canRallyPeople"
                checked={formState.canRallyPeople}
                onCheckedChange={(checked) =>
                  setFormState({ ...formState, canRallyPeople: !!checked })
                }
              />
              <Label
                htmlFor="canRallyPeople"
                className="font-sans text-muted-foreground"
              >
                Can Rally People
              </Label>
            ...
            <div className="flex items-center text-left space-x-1">
              <Checkbox
                id="mustPhotograph"
                checked={formState.mustPhotograph}
                onCheckedChange={(checked) =>
                  setFormState({ ...formState, mustPhotograph: !!checked })
                }
              />
              <Label
                htmlFor="mustPhotograph"
                className="font-sans text-muted-foreground"
              >
                Must Photograph
              </Label>
            ...
            <div className="flex items-center text-left space-x-1">
              <Checkbox
                id="dontPhotograph"
                checked={formState.dontPhotograph}
                onCheckedChange={(checked) =>
                  setFormState({ ...formState, dontPhotograph: !!checked })
                }
              />
              <Label
                htmlFor="dontPhotograph"
                className="font-sans text-muted-foreground"
              >
                Don&apos;t Photograph
              </Label>
